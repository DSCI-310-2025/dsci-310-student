...
My role:
I worked with most aspects of the project including coding, as well as writing parts and the vignette. In the beginning I contributed to the research in choosing what test to use (Cramer) in order to decide which parameters are useful. Moreover, we set up meetings before every milestone and split tasks with each other based on everybody's preferences. 

Kaylee's role:
Kaylee mostly worked with Nicholas to set up the environment and makefile aspects of the project. She also helped with the rest of the tasks as needed including coding parts when we split the tasks.

Luke's role:
Luke also contributed to the writing as well as the coding aspects. He worked with me in some milestones on big chunks and independently on the smaller ones.

Nicholas's role:
Nicholas worked with Kaylee in some milestones on setting up docker etc. He also set up most of the repositories as were required for some milestones. While, also contributing to the rest of the tasks, as needed or agreed upon in the meetings. 

- What went well and poorly throughout the team project experience?
Overall, the project was smooth. What went well was that we made a groupchat and regularly updated each other and asked for help if needed. Everybody was super helpful and would respond quickly. We also regularly editted each others work if someone was having issues. 

 What could be improved was that for one of the milestones we miscalculated the amount of time it would take for one of the tasks and kind of left things to the last minute and it was very stressful to work on it as the deadline was approaching. However, we decided to start the rest of them way earlier to avoid the same thing happening. Overall, everything was fairly smooth.
